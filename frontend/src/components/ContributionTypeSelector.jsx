export default function ContributionTypeSelector({ type, setType }) {
  return (
    <div className="mb-4 p-4 rounded-lg bg-[var(--hi-white)] border border-[var(--hi-gray-border)] shadow-sm">
        ...
        <button
          ...
          className={`flex-1 px-4 py-3 rounded-lg border-2 transition font-medium
            ${type === "percentage"
              ...
              : "bg-[var(--hi-white)] text-[var(--hi-dark-navy)] border-[var(--hi-gray-border)] hover:border-[var(--hi-primary-blue)]"
            }
          `}
        >
          Percentage (%)
